...
in  { Type =
        ...
        , DeletionProtectionEnabled : Optional Fn.CfnText
        , GlobalSecondaryIndexes :
            Optional
              (List (./ReplicaGlobalSecondaryIndexSpecification.dhall).Type)
    ...
    , default =
      ...
      , DeletionProtectionEnabled = None Fn.CfnText
      , GlobalSecondaryIndexes =
          None (List (./ReplicaGlobalSecondaryIndexSpecification.dhall).Type)
      , KinesisStreamSpecification =
          None (./KinesisStreamSpecification.dhall).Type
      , PointInTimeRecoverySpecification =
